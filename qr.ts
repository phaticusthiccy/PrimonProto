...
//
//
// filter_media [object] // Decerepted
// {
//     "type": "",
//     "media": "",
//     "jid": "",
        ...
        rl.question(
          ...
          async (answer2) => {
            if (answer2 == 1) {
              ...
              rl.question(chalk.blue("Anahtarı Girin :: "), async (a1) => {
                ...
                rl.question(chalk.blue("Anahtarı Girin :: "), async (a2) => {
                  ...
                  rl.question("\n\n[Enter Tuşuna Bas]", async (answer7) => {
                    ...
                    await delay(1500);
                    console.log(
                      chalk.green("Şimdi ise ekrana gelecek QR kodunu okutun.")
                    );
                    await delay(2800);
                    console.log(
                      chalk.red(
                        "QR Okuttuktun Sonra Lütfen Sistemi Tekrar Çalıştırın!"
                      )
                    );
                    await delay(5000);
                    console.clear();
              ...
              console.log(chalk.green("Railway Hesap Oluşturma Seçildi!"));
              await delay(3000);
              console.clear();
              console.log(pmsg);
              await delay(1500);
              ...
              rl.question("[Enter Tuşuna Bas]", async () => {
                ...
                await delay(1500);
                console.log(
                  chalk.green("Şimdi ise hesabınızın durumunu kontrol edelim.")
                );
                console.log("\n\n");
                await delay(3000);
                console.log(
                ...
                console.log(
                  chalk.green(
                    "Ayrıca Railway, sizden hesanınızı onaylamanızı istiyorsa; hesap onaylanmadığı sürece botu kuramazsınız."
                  )
                );
                console.log("\n\n");
                await delay(3000);
        ...
        rl.question(
          ...
          async (answer2) => {
            if (answer2 == 1) {
                      ...
                      async (answer6) => {
                        ...
                        rl.question(
                          ...
                          async (answer7) => {
                            ...
                            console.log(
                              chalk.red(
                                "After scanned the QR, please run the system again!"
                              )
                            );
                            await delay(5000);
                            console.clear();
              ...
              console.log(chalk.green("Railway Account Creation Selected!"));
              await delay(3000);
              console.clear();
              console.log(pmsg);
              await delay(1500);
              ...
              await delay(3000);
              console.log(
                chalk.green("Press [Enter] to continue after logging in.")
              );
              console.log("\n\n");
              rl.question("[Press Enter Key]", async () => {
                ...
                await delay(1500);
                console.log(
                  chalk.green("Now let's check the status of your account.")
                );
                console.log("\n\n");
                await delay(3000);
                console.log(
    ...
    command.stdout.on("end", async () => {
      ...
      rl.question("\n\n[Enter Tuşuna Bas]", async () => {
        ...
        rl.question("\n\nAnahtarı Girin :: ", async (proj) => {
          ...
          var prj = shell.exec(
            "cd PrimonProto && node railway.js link " + proj
          );
          var sh4 = shell.exec(
            "cd PrimonProto/ && node railway.js variables set GITHUB_DB=" +
              fs.readFileSync("./gb_db.txt").toString()
          );
          var sh5 = shell.exec(
            "cd PrimonProto/ && node railway.js variables set GITHUB_AUTH=" +
          ...
          shell.exec(
            "cd PrimonProto/ && node railway.js variables set SESSION2=" +
              tkn[1]
          );
          shell.exec(
            "cd PrimonProto/ && node railway.js variables set SESSION3=" +
              tkn[2]
          );
          shell.exec(
            "cd PrimonProto/ && node railway.js variables set SESSION4=" +
              tkn[3]
          );
          shell.exec(
